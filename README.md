...
Consiste en programar un simulador básico de batallas de gimnasio inspirado en Pokémon, implementado en consola y aplicando principios de Programación Orientada a Objetos.  
...
## Pasos para ejecutar
- Una vez compilado, usar el siguiente comando para inicializar el juego: **java Main**.
- Luego, seguir las instrucciones dadas en la terminal y disfrutar el juego. 
